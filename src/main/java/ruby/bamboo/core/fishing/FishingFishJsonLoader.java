 ...
 *
 * <p>1.21.1 NeoForge: WishJsonLoader と同一形式 (GAME bus + ResourceLocation.parse)。
 * JSON形式は master と同一で互換あり ("item" キーは本ローダーが手動parseするため、
 * 1.21 ItemStack.CODEC の "id" 化の影響を受けない)。
 */
