...
public class ColoredLightConfig {
    ...
    public static class Client {
        /** 昼光抑制の有効/無効 */
        public final ModConfigSpec.BooleanValue daylightSuppressEnabled;
        /** 日中屋外での抑制率 (0.0-1.0)。alpha *= 1-daylight*rate */
        public final ModConfigSpec.DoubleValue daylightSuppressRate;
        /** 昼光の量子化レベル数。レベル変化時のみ再焼き込み (日中・夜間は不変で無コスト) */
        public final ModConfigSpec.IntValue daylightLevels;
        /** 1tickにdirty化する最大セクション数 (負荷分散用) */
        public final ModConfigSpec.IntValue sectionsPerTick;
        /** 光源からdirty化するセクション半径 (getTintの半径12に合わせる) */
        public final ModConfigSpec.IntValue dirtyRadius;
