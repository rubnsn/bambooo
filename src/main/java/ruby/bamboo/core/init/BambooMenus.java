...
public final class BambooMenus {
    ...
    public static final RegistryObject<MenuType<MillStoneMenu>> MILL_STONE = BambooMod.MENUS.register("mill_stone",
            () -> new MenuType<>(MillStoneMenu::new, FeatureFlags.VANILLA_SET));

    /** 囲炉裏のメニュー。クライアント側ファクトリは (id, inv) 2引数版 */
    public static final RegistryObject<MenuType<CampfireMenu>> CAMPFIRE = BambooMod.MENUS.register("campfire",
