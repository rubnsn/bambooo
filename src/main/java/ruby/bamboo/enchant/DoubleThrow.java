...
public class DoubleThrow extends EnchantmentBase {
    public DoubleThrow(Rarity rarity, EnchantmentCategory category, EquipmentSlot... slots) {
    ...
    @Override protected boolean checkCompatibility(Enchantment other) {
        if (other instanceof TripleThrow) return false;
