...
public class TomatoPlantBlock extends CropBlock {
    ...
    /** 種兼用アイテム (トマト) の ID。親の BambooItems.TOMATO 配線後に解決される。 */
    public static final ResourceLocation SEED_ID = ResourceLocation.fromNamespaceAndPath(BambooMod.MODID, "tomato");
    ...
    public Item asItem() {
        ...
        // 未配線時は AIR 相当 (super) を返し、配線後にトマトを返す。
