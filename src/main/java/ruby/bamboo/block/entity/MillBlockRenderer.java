 ...
 * 超えるが、{@code shouldRenderOffScreen() = true} で描画される
 * (1.21 の BlockEntity に getRenderBoundingBox() は無いため BER 側のみで対応)。
 */
public class MillBlockRenderer implements BlockEntityRenderer<MillBlockEntity> {

    public static final ResourceLocation WINDMILL_TEXTURE = ResourceLocation.fromNamespaceAndPath(BambooMod.MODID,
            "textures/entity/windmill.png");
    public static final ResourceLocation WINDMILL_CLOTH_TEXTURE = ResourceLocation.fromNamespaceAndPath(BambooMod.MODID,
            "textures/entity/windmill_cloth.png");
    public static final ResourceLocation WATERWHEEL_TEXTURE = ResourceLocation.fromNamespaceAndPath(BambooMod.MODID,
