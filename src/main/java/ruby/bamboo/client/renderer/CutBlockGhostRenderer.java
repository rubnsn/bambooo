...
public class CutBlockGhostRenderer {
    ...
    private static void renderTranslucentBox(PoseStack poseStack, MultiBufferSource buffer,
        ...
        quad(vc, pose, minX, minY, minZ, maxX, minY, minZ, maxX, minY, maxZ, minX, minY, maxZ, 0,-1,0, r,g,b,a);
        quad(vc, pose, minX, maxY, maxZ, maxX, maxY, maxZ, maxX, maxY, minZ, minX, maxY, minZ, 0,1,0, r,g,b,a);
        quad(vc, pose, maxX, minY, minZ, minX, minY, minZ, minX, maxY, minZ, maxX, maxY, minZ, 0,0,-1, r,g,b,a);
        quad(vc, pose, minX, minY, maxZ, maxX, minY, maxZ, maxX, maxY, maxZ, minX, maxY, maxZ, 0,0,1, r,g,b,a);
        quad(vc, pose, minX, minY, minZ, minX, minY, maxZ, minX, maxY, maxZ, minX, maxY, minZ, -1,0,0, r,g,b,a);
        quad(vc, pose, maxX, minY, maxZ, maxX, minY, minZ, maxX, maxY, minZ, maxX, maxY, maxZ, 1,0,0, r,g,b,a);
    }
    ...
    private static void renderWireframeBox(PoseStack poseStack, MultiBufferSource buffer,
        ...
        line(vc, pose, minX,minY,minZ, maxX,minY,minZ, r,g,b,a);
        line(vc, pose, maxX,minY,minZ, maxX,minY,maxZ, r,g,b,a);
        line(vc, pose, maxX,minY,maxZ, minX,minY,maxZ, r,g,b,a);
        line(vc, pose, minX,minY,maxZ, minX,minY,minZ, r,g,b,a);
        line(vc, pose, minX,maxY,minZ, maxX,maxY,minZ, r,g,b,a);
        line(vc, pose, maxX,maxY,minZ, maxX,maxY,maxZ, r,g,b,a);
        line(vc, pose, maxX,maxY,maxZ, minX,maxY,maxZ, r,g,b,a);
        line(vc, pose, minX,maxY,maxZ, minX,maxY,minZ, r,g,b,a);
        line(vc, pose, minX,minY,minZ, minX,maxY,minZ, r,g,b,a);
        line(vc, pose, maxX,minY,minZ, maxX,maxY,minZ, r,g,b,a);
        line(vc, pose, maxX,minY,maxZ, maxX,maxY,maxZ, r,g,b,a);
        line(vc, pose, minX,minY,maxZ, minX,maxY,maxZ, r,g,b,a);
    }

    private static void quad(VertexConsumer vc, com.mojang.blaze3d.vertex.PoseStack.Pose pose,
        ...
        vc.addVertex(pose, x4,y4,z4).setColor(r,g,b,a).setNormal(pose, nx,ny,nz);
    }
