 ...
 *
 * <p>1.21.1: エンチャント可否は datapack の supported_items に一任するため
 * {@code isEnchantable} のみ false 化 (旧 isBookEnchantable /
 * canApplyAtEnchantingTable は撤去、NinjaBraceletItem の先例に準拠)。
 */
