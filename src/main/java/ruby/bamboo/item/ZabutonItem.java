 ...
 * <p>
 * 1.21: EntityType解決を {@link ZabutonEntity#registryType()} 経由に変更
 * (登録は親が {@code BambooEntities.ZABUTON} へ配線)。その他変更なし。
 */
public class ZabutonItem extends Item {
    ...
    public InteractionResult useOn(UseOnContext ctx) {
        ...
        ZabutonEntity entity = new ZabutonEntity(ZabutonEntity.registryType(), level);
        entity.setPos(x, y, z);
        entity.setYRot(yaw);
