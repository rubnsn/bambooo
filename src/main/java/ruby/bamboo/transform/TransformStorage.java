 ...
 *
 * <p>1.21.1 NeoForge: 旧 Forge Cap (INBTSerializable/LazyOptional) を捨て、
 * NeoForge AttachmentType 方式へ移行。永続化あり ({@code serialize + copyOnDeath})。
 * master 仕様 (Clone/ログイン/リスポーン維持) のため死亡時も維持する。
 */
